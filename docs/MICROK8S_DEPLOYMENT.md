...
Create a Python virtual environment and install the SDK and server:
...
> **Note:** Activate the venv (`source .venv/bin/activate`) in every new terminal before running `opensandbox-server` or the example scripts.
